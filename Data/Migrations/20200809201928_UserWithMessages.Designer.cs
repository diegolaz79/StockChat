...
namespace StockChat.Data.Migrations
{
    ...
    [Migration("20200809201928_UserWithMessages")]
    partial class UserWithMessages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockChat.Models.ChatUser", b =>
                {
            ...
            modelBuilder.Entity("StockChat.Models.Message", b =>
                {
                    b.HasOne("StockChat.Models.ChatUser", "Sender")
                        .WithMany("Messages")
                        .HasForeignKey("UserID");
                });
